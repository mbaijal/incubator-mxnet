...
echo "${virtualenv_commands}"
echo
nvidia-docker run --rm mbaijal/cuda9_sudo bash -c "${virtualenv_commands}"

echo
echo "### Testing Pip ###"
echo "${pip_commands}"
echo
nvidia-docker run --rm mbaijal/cuda9_sudo bash -c "${pip_commands}"
...
echo "${buildfromsource_commands}"
echo
nvidia-docker run --rm mbaijal/cuda9_sudo bash -c "${buildfromsource_commands}"
